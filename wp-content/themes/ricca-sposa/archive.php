                ...
                <div class="products-list">
                	...
                	<div id="<?php echo $post->ID ?>" class="product-col">
                        <div class="product-item">
							...
							<?php 
                                $postTerms = wp_get_post_terms($post->ID, array ('type','collections'), 'names' );
                                 
                                foreach( $postTerms as $term ) {
                                    $sale = get_field( 'sale', $term );
                                    $dress_sale = get_field( 'dress_sale' );
                                    if(strlen($sale) > 0){
                                        echo '<div class="sale-label">Sale <span>-'. $sale .'%</span></div>';
                                    } else if (strlen($dress_sale) > 0) {
                                        echo '<div class="sale-label">Sale <span>-'. $dress_sale .'%</span></div>';
                                    } else {
										echo '';
									}
                                }
