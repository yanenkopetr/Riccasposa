...
<section class="section-catalog-list">
    <div class="container">
        ...
        <div class="catalog-col">
                            ...
                            <div class="product-img">
                                <button class="btn-add-basket">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    	 viewBox="0 0 471.701 471.701" style="enable-background:new 0 0 471.701 471.701;width:17px;height:15px" xml:space="preserve">
            ...
            <?php endif;?>
             <?php echo do_shortcode('[ajax_load_more id="1292122556" loading_style="infinite classic" container_type="div" css_classes="products-list" pause="true" post_type="dresses" posts_per_page="9" scroll="false" scroll_container=".section-catalog-list" images_loaded="true" button_label="Загрузить ещё"]');?>
        </div>
    </div>
</section>
